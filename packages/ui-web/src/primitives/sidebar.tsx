...
import { Separator } from "@repo/ui-web/primitives/separator"
import {
  Sheet,
  SheetContent,
  SheetDescription,
...
import { Skeleton } from "@repo/ui-web/primitives/skeleton"
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
} from "@repo/ui-web/primitives/tooltip"
import { PanelLeftIcon } from "lucide-react"

const SIDEBAR_COOKIE_NAME = "sidebar_state"
const SIDEBAR_COOKIE_MAX_AGE = 60 * 60 * 24 * 7
const SIDEBAR_WIDTH = "calc(16 * var(--app-size))"
const SIDEBAR_WIDTH_MOBILE = "calc(18 * var(--app-size))"
const SIDEBAR_WIDTH_ICON = "calc(3 * var(--app-size))"
